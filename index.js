...
const corsOptions = {
  origin: ['http://localhost:5173', 'https://taqueando.netlify.app'], // aquí puedes agregar otros orígenes válidos si los necesitas
...
app.use('/logs', require('./routes/userLog.routes'));
